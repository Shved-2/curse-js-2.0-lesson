...
const f4 = () => {
  ...
  document.querySelector('.out-4').innerHTML = s4.has(inp.value);
  inp.value = '';
};
...
const f7 = () => {
  ...
  let s7 = new Set(inp7.value.split(''));
  if (s7.size > 6 && inp7.value.length == s7.size) {
...
const f13 = () => {
  let ar13 = str12.split('');
  let s13 = new Set(str12.split(''));
  let finSet = {};
