...
function t8() {
  ...
  document.querySelector('.out-8').textContent = in8;
}
...
function t9() {
  ...
  document.querySelector('.out-9').textContent = in9.value;
  in9.value = '';
}
...
function t16() {
  ...
  document.querySelector('.out-16').textContent = i161 + i162;
}
...
function t19() {
  ...
  document.querySelector('.out-19').textContent = i191 + i192;
}
