...
let elem6 = document.getElementById('six');
elem6.textContent = 'Hello World';
// Task 7.
...
let elem7 = document.getElementById('seven');
elem7.textContent = 12 * 12;
// Task 8.
// На странице создан div.out-8. С помощью document.querySelector запишите в данный элемент текст 'task-8'.
let elem8 = document.querySelector('.out-8');
elem8.textContent = 'task-8';
...
let elem9 = document.querySelector('.out-9');
elem9.innerHTML = 'world';
// Task 10.
//На странице создан div.out-10. С помощью innerHTML запишите внутрь него следующую строку '<h2>Hi</h2>'.
let elem10 = document.querySelector('.out-10');
elem10.innerHTML = '<h2>Hi</h2>';
// Task 11.
...
let elem11 = document.querySelector('.out-11');
elem11.innerHTML = '123';
elem11.innerHTML += '456';
...
let elem12 = document.querySelector('.out-13');
elem12.innerHTML =
  '<img src="https://cdn3.iconfinder.com/data/icons/web-design-and-development-2-10/66/67-256.png" alt="js">';
// Task 14.
...
let elem18 = document.querySelector('.out-18');
console.log(elem18);
elem18.innerHTML = 5;
console.log(elem18);
// Task 19.
...
let elem19 = document.querySelector('.out-19');
console.log(elem19);
elem19 = document.querySelector('.out-19-test');
console.log(elem19);
// Task 20
...
let elem20 = document.querySelector('.out-20');
elem20.textContent = '<h2>Hi</h2>';
