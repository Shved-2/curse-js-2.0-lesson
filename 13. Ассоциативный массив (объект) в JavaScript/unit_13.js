...
function f6() {
  ...
  let iElem = document.querySelector('.i-62').value;
  a6[iKey] = iElem;
  f5(a6, '.out-6');
}
...
function f9() {
  ...
  let iElem = +document.querySelector('.i-9').value;
  let str = ' ';
  for (let key in a9) {
    if (a9[key] == iElem) {
      str += key + ' ';
...
function f11() {
  let iKey = document.querySelector('.i-11').value;
  for (let key in a11) {
    if (key == iKey) {
      delete a11[key];
    }
...
function f12() {
  let iKey = document.querySelector('.i-12').value;
  for (let key in a12) {
    if (a12[key] == iKey) {
      delete a12[key];
    }
...
function f16() {
  ...
  document.querySelector('.out-16').innerHTML = str;
}
...
function f17() {
  let str = '';
  for (let key in a17) {
    if (a17[key]['age'] > 30) str += a17[key]['name'] + ' ';
  }
  document.querySelector('.out-17').innerHTML = str;
}
